...
namespace Medialtesting
{
    ...
    class PriorityQueue
    {
         ...
         */
        private float maxPriority = float.MaxValue;
		...
		private Hashtable elementToPriority;
        ...
        private void init(int size)
        {
            ...
            value[0] = maxPriority;
            data[0] = null;
			elementToPriority= new Hashtable(size);
        }
        ...
        public void add(Object element, float priority)
        {
            ...
            data[count] = element;
            bubbleUp(count);
			elementToPriority.Add(element,priority);
        }
		...
		public float getPriority(Object element){
			return (float)elementToPriority[element];
		}

		public void UpdatePriority(Object element, float newPriority){
			elementToPriority[element]=newPriority;
