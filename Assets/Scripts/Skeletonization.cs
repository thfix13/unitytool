...
public class Skeletonization
{
	...
	{
		imax = (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x);
		jmax = (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y);
	...
	public void calculateBoundaries (GameObject floor)
	{
		...
		for (int i = 0; i < (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x) + 1; i++) {
			for (int j = 0; j < (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y) + 1; j++) {
				...
				if ((i > 0 && obs [i - 1] [j].blocked == true) ||
					...
					(i < (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x) && (obs [i + 1] [j].blocked == true)) ||
					(j < (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y) && (obs [i] [j + 1].blocked == true)) ||
					(i < (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x) && j < (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y) && (obs [i + 1] [j + 1].blocked == true)) ||
					(i == 0) || (j == 0) ||
					(i == (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x)) ||
					(j == (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y))) {
...
//				prevPosX = SpaceState.Editor.tileSize.x * prevNode.x1 + SpaceState.Editor.tileSize.x / 2.0f + floor.collider.bounds.min.x;
//				prevPosY = SpaceState.Editor.tileSize.y * prevNode.y1 + SpaceState.Editor.tileSize.y + floor.collider.bounds.min.z;
//			}
//			if (prevNode.y1 == prevNode.y2 && prevNode.x2 - prevNode.x1 == 1) {
//				prevPosX = SpaceState.Editor.tileSize.x * prevNode.x2 + floor.collider.bounds.min.x;
//				prevPosY = SpaceState.Editor.tileSize.y * prevNode.y1 + SpaceState.Editor.tileSize.y / 2.0f + floor.collider.bounds.min.z;
//			}
//			if (curNode.x1 == curNode.x2 && curNode.y2 - curNode.y1 == 1) {
//				curPosX = SpaceState.Editor.tileSize.x * curNode.x1 + SpaceState.Editor.tileSize.x / 2.0f + floor.collider.bounds.min.x;
//				curPosY = SpaceState.Editor.tileSize.y * curNode.y1 + SpaceState.Editor.tileSize.y + floor.collider.bounds.min.z;
//			}
//			if (curNode.y1 == curNode.y2 && curNode.x2 - curNode.x1 == 1) {
//				curPosX = SpaceState.Editor.tileSize.x * curNode.x2 + floor.collider.bounds.min.x;
//				curPosY = SpaceState.Editor.tileSize.y * curNode.y1 + SpaceState.Editor.tileSize.y / 2.0f + floor.collider.bounds.min.z;
//			}
...
//		}
	...
	public void boundaryPointsFlooding (GameObject floor)
	{
		...
		while (iList.Count != 0) {
			...
			if (i < (int)(floor.collider.bounds.size.x / SpaceState.Editor.tileSize.x)
			...
			if (j < (int)(floor.collider.bounds.size.z / SpaceState.Editor.tileSize.y)
